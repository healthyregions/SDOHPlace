...
2. **Block Groups Within a Half Mile Buffer of a Transit Stop**
   ...
   * These block groups are marked or categorized based on whether they meet this proximity criterion.</li><li>This approach assumes that everyone within the selected block groups has similar access to the transit stop.
