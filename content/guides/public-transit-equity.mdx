...
description: 'This is an example description that we could include for a guide, if we wanted to describe it in more detail for the users before they click on it.'
