---
title: Developing a Food Resource Hub for a Low-Income Community in Northeastern
  Connecticut
slug: food-resource-hub
date: 2024-07-26
author: herop-lab
...
## Developing a Food Resource Hub for Northeastern Connecticut 
...
This map is aimed at helping members of the Windham and Willimantic community, which is a low-income community in Connecticut, to maximize knowledge of local resources. Resources include grocery stores, physical activity, and public transportation. The goal is to decrease chronic disease risks by improving nutrition and physical activity status through education.

Target users of this application include low-income, those receiving federal assistance programs, or those utilziing food pantries.
...
![Screenshot of the Food Access Map showing grocery stores in an area with bus routes. ](/images/picture1-peter-chen-peter-.png)
...
This project is completed and ready for all members of the Windham and Willimantic community to use. 
...
If you are a community member Windham and/or Willimantic, Connecticut, or would just like to check out Peter's work, you can access the application here.
