...
## Session A - Classroom A

#### 10:15am - Rachel Loftus
...
<details>
<summary>“Uncovering the Factors of Diabetes: A Multi-Level SDOH Analysis Using AI and Geospatial Techniques” </summary>

The burden of diabetes in the United States is inequitably distributed, reflecting deep-seated social and environmental injustices. This project advances a health equity framework by integrating geospatial analysis, machine learning, and regression model building to evaluate counties with the highest diabetes prevalence and uncover the specific social determinants of health (SDOH) and environmental hazards driving these disparities. We assemble a multi-source dataset integrating county-level diabetes prevalence (CDC BRFSS); Healthy People 2030-aligned SDOH indicators (County Health Rankings & Roadmaps, American Community Survey); and environmental burden measures from the Environmental Justice Index (EJI). The framework is first applied to Illinois’ 102 counties and then scaled nationally.

Analytically, we construct bivariate choropleth maps pairing diabetes prevalence with targeted SDOH or environmental indicators to reveal spatial co-concentrations of disease and disadvantage. Tertile classifications (L/M/H; H = highest prevalence or greatest disadvantage) surface priority counties where elevated diabetes aligns with food insecurity, economic hardship, or environmental stressors. Our modeling strategies include (1) regularized regression and gradient boosting and (2) estimating and ranking predictor importance while adjusting for potential confounders. The confounding analysis includes k-fold cross-validation, assumption diagnostics, and residual mapping to highlight unexplained variation and data gaps.

Furthermore, the mapping application is implemented in Tableau Public. The webpage with two major dashboards was refined through participatory design with public health professionals and researchers. This approach promotes decision-support features (county profiles, evidence-based, filterable indicators) that translate analytic insights into practical guidance for screening, prevention, and policy. By synthesizing predictor rankings and modeling with place-based bivariate maps, the dashboards help decision-makers target resources toward the most impactful SDOH and pinpoint the communities where interventions are most needed.
</details>
...
The motivation for developing an Illinois Environmental Health Data and Map

Dashboard was inspired by engaging with different communities in Illinois and learning how

environmental burdens have adversely impacted the health and well-being of their

neighborhoods and residents. These communities face intersecting challenges related to

environmental disparities, socioeconomic hardships, and health inequities. I am developing a

data visualization dashboard to highlight relevant place-based data, which can be valuable for

communities to understand their own neighborhood conditions, communicate information to

various stakeholders in local planning and development initiatives, and support efforts for new

environmental health programs and funding opportunities. The interactive dashboard includes

data variables for Illinois census tracts and county-level information on different population

demographics, environmental and climate conditions, and health vulnerabilities. Future

versions of the dashboard will further center communities through partnerships with local

leaders and groups and by incorporating their feedback to enhance the usability, accessibility,

and relevance of the Illinois Environmental Health Data and Map Dashboard for these
...
<details>
<summary>“Social Infrastructure & Access in Denver–Boulder: A Spatial Health Equity Dashboard”</summary>

Access to social infrastructure—places that support social connection, care, and community engagement—is a critical determinant of health and wellbeing. Parks, cafés, recreation centers, libraries, and civic sites can reduce loneliness, strengthen social networks, and bolster resilience, yet their availability and accessibility vary widely across neighborhoods. This project develops a place-based, equity-focused interactive dashboard visualizing social infrastructure across the Denver–Boulder (CO) metropolitan area. Using the National Establishment Time-Series Database (NETS), American Community Survey demographic data, and tract-level spatial analysis, the workflow merges, standardizes, and aggregates thousands of site records into category-specific counts and per-capita measures. Hotspot and cluster analyses highlight where social infrastructure is concentrated, where gaps exist, and how patterns align with neighborhood socioeconomic and racial/ethnic composition. The dashboard enables users to explore maps, charts, and accessibility metrics, supporting public health, urban planning, and community-driven decision-making. By integrating transparent, reproducible GIS methods with user-friendly visualization, this project advances understanding of how place shapes opportunities for social connection and health, and offers a flexible tool for equity-oriented planning throughout the Denver–Boulder region.
</details>
