...
slug: mapping-montgomery
date: 2024-07-23
author: herop-lab
tags:
  - showcase
thumbnail: /images/amy.png
...
<p style="margin-top:0.5rem;">Tech Stack Used: <span style="color: #7E1CC4;">R, R-Shiny</span></p>

**By:** [Amy Kryston, MS, MPH,](https://www.linkedin.com/in/amy-kryston) UNC Gillings School of Global Public Health

<p style="margin-top:0.5rem;">Fellow Cohort: <span style="color: #7E1CC4;">Spring 2024</span></p>

<a href="https://akryston.shinyapps.io/final_map/" target="_blank"><button style="background-color: #7E1CC4; color: #ffffff; border: 0; padding: 0.75rem 1.25rem; border-radius: 1.5rem; font-size: 1rem; cursor: pointer">Explore App →</button></a>
...
![](/images/food-assets-ss.png "Food resources displayed within the mapping application.")<span style={{fontSize:'.8em', fontStyle:'italic'}}>Food resources displayed within the mapping application.</span>

Also, recreation resources, like public parks and private gyms. 

![](/images/recreation-assets-ss.png "Recreational assets displayed within the mapping application.")<span style={{fontSize:'.8em', fontStyle:'italic'}}>Recreational assets displayed within the mapping application.</span>
