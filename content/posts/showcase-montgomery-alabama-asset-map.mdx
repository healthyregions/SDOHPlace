...
![](/images/screenshot-amy-kryston.png "Asset map view of all services available: recreation and food")<table><caption>Asset map view of all services available: recreation and food.</caption><table>
...
![](/images/food-assets-ss.png "Food resources displayed within the mapping application.")<caption><i>Food resources displayed within the mapping application.</i></caption>

Also, recreation resources, like public parks and private gyms. 

![](/images/recreation-assets-ss.png "Recreational assets displayed within the mapping application.")<caption><i>Recreational assets displayed within the mapping application.</i></caption>
...
**Link to Web App:** [akryston.shinyapps.io/final_map](https://akryston.shinyapps.io/final_map/)\
