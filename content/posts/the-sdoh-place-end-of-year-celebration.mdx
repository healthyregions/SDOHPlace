...
While the celebration itself is invite-only, we will be Live Streaming the event at our Healthy Regions & Policies Lab YouTube channel! Get notified when we go live, and watch the live stream by clicking the following link: [go.illinois.edu/EOY-LIVE](http://go.illinois.edu/EOY-LIVE)
