...
The Design Sprint Application can be accessed here: https://go.illinois.edu/design-sprint-apply 

The following items are required and can be shared by filling out the application form using the link provided at the end of this section:
