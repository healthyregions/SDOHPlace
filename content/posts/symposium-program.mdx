...
**4:40 PM: Pechakucha/Lightning Talks**

This is sure to be a fun session! For those unfamiliar, a Pechakucha is a style of presentation originating from Japan. Presenters are allotted 20 slides each, and every slide automatically advances after 20 seconds—no do-overs! Watch the livestream for interesting ideas, conveyed in a fun and entertaining style!
...
#### Following the Keynote, we will showcase the data application prototypes created by the SDOH & Place Fellows.

Be sure to stop by for these sessions!

**10 AM: Fellowship Session: Story Map Group**

A majority of Fellows in this group have created a Story Map—a map that conveys a story surrounding the data—for their communities. 

**11:15 AM: Fellowship Session: Asset Map Group**

A majority of the Fellows in this group have created an Asset Map—a point map of resources—for their communities.

**1:30 PM: Fellowship Session: Data Dashboard Group**

All of the Fellows in this group have created a Data Dashboard— an interactive interface for exploratory data analysis— for their communities. 

**2:00 PM: Environmental Justice in Chicago with Instituto Progresso Latino**

We will conclude with a final talk presented by a local Environmental Justice group in Chicago, the Instituto Progresso Latino. This talk will be a bilingual presentation
