...
const recommendations = [{
  ...
  excerpt: 'Example project that we would like to highlight for the following awesome reasons: 1) we like it, 2) it\'s pretty cool, and 3) we should know about it if you\'re interested in our platform',
}]
