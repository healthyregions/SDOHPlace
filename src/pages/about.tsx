  ...
  return (
    <>
      ...
      <div className="bg-white flex flex-col">
        ...
        <div className="self-center z-[1] flex w-full max-w-[1259px] flex-col mt-[200px] mb-[400px] px-5 max-md:max-w-full max-md:mt-10">
          <div className="text-stone-900 text-2xl font-bold max-md:ml-2.5">Core Team</div>
          <p className="text-stone-900 text-2xl leading-8 mt-10 self-center max-w-[1259px] max-md:max-w-full max-md:mt-10">
            Our team is based out of the University of Illinois at Urbana-Champaign via Dr. Kolak's{" "}
            ...
            <br />
            <br />
            This project is funded in part by the Robert Wood Johnson Foundation.
          </p>
        </div>
