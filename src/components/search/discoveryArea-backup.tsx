...
import SearchRow from "./searchArea/searchRow-backup";
import ResultsPanel from "./resultsPanel/resultsPanel-backup";
...
export default function DiscoveryAreaBK({ schema }: { schema: {} }): JSX.Element {
